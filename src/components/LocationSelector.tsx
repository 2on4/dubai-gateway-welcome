        ...
        <div className="flex-1">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button className="w-full bg-secondary border border-border rounded-lg px-4 py-3 text-left text-white flex items-center justify-between hover:bg-secondary/80 transition-colors">
